...
- Snapshot window: `2026-07-15T08:58:02+02:00` to `2026-07-15T13:30:14+02:00` local (`65` snapshots)
- Entities in KB: `773,785` (`+309` today)
- Relationships in KB: `16,113,166` (positive gain `+14,015`, net `+14,015`)
- Completed entities (all pages crawled): `152` (`+0` today)
- Queue: `done 21 (+0)`, `processing 6 (-4)`, `pending 146,928 (+931)`, `errors 0 (+0)`
...
|---|---:|---:|---:|---:|---:|---|
| 2026-07-15 | 16,113,166 | +14,015 | 773,785 | 152 | 146,928 |  |
