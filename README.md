...
- Snapshot window: `2026-07-16T08:14:35+02:00` to `2026-07-16T20:37:38+02:00` local (`188` snapshots)
- Entities in KB: `775,588` (`+958` today)
- Relationships in KB: `16,197,601` (positive gain `+47,070`, net `+47,070`)
- Completed entities (all pages crawled): `152` (`+0` today)
- Queue: `done 21 (+0)`, `processing 11 (+5)`, `pending 151,927 (+1,828)`, `errors 0 (+0)`
...
|---|---:|---:|---:|---:|---:|---|
| 2026-07-16 | 16,197,601 | +47,070 | 775,588 | 152 | 151,927 |  |
