...
- Snapshot window: `2026-07-17T09:47:10+02:00` to `2026-07-17T09:54:58+02:00` local (`4` snapshots)
- Entities in KB: `775,817` (`+0` today)
- Relationships in KB: `16,211,750` (positive gain `+0`, net `+0`)
- Completed entities (all pages crawled): `152` (`+0` today)
- Queue: `done 21 (+0)`, `processing 16 (+0)`, `pending 152,479 (+0)`, `errors 0 (+0)`
...
|---|---:|---:|---:|---:|---:|---|
| 2026-07-17 | 16,211,750 | +0 | 775,817 | 152 | 152,479 |  |
