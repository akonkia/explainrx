...
- Snapshot window: `2026-07-16T08:14:35+02:00` to `2026-07-16T17:15:04+02:00` local (`142` snapshots)
- Entities in KB: `775,365` (`+735` today)
- Relationships in KB: `16,184,137` (positive gain `+33,606`, net `+33,606`)
- Completed entities (all pages crawled): `152` (`+0` today)
- Queue: `done 21 (+0)`, `processing 10 (+4)`, `pending 151,641 (+1,542)`, `errors 0 (+0)`
...
|---|---:|---:|---:|---:|---:|---|
| 2026-07-16 | 16,184,137 | +33,606 | 775,365 | 152 | 151,641 |  |
