...
- Snapshot window: `2026-07-18T00:13:49+02:00` to `2026-07-18T00:13:49+02:00` local (`1` snapshots)
- Entities in KB: `776,239` (`+0` today)
- Relationships in KB: `16,222,254` (positive gain `+0`, net `+0`)
- Entity page crawls exhausted: `160` (`+0` today)
- Queue backlog: `processing 0 (+0)`, `pending 154,109 (+0)`, `errors 0 (+0)`
...
|---|---:|---:|---:|---:|---:|---|
| 2026-07-18 | 16,222,254 | +0 | 776,239 | 160 | 154,109 |  |
