...
- Snapshot window: `2026-07-18T00:13:49+02:00` to `2026-07-18T15:36:34+02:00` local (`61` snapshots)
- Entities in KB: `779,044` (`+2,805` today)
- Relationships in KB: `16,285,344` (positive gain `+63,090`, net `+63,090`)
- Entity page crawls exhausted: `163` (`+4` today)
- Queue backlog: `processing 0 (+0)`, `pending 170,901 (+16,792)`, `errors 0 (+0)`
- Entity dedup backlog: `210,889` remaining of `211,179` candidate pairs (`0.14%` covered)
...
|---|---:|---:|---:|---:|---:|---|
| 2026-07-18 | 16,285,344 | +63,090 | 779,044 | 163 | 170,901 |  |
