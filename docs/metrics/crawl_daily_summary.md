...
- Snapshot window: `2026-07-14T18:30:12+02:00` to `2026-07-14T22:08:44+02:00` local (`61` snapshots)
- Entities in KB: `773,427` (`+202` today)
- Relationships in KB: `16,096,056` (positive gain `+6,638`, net `+6,638`)
- Completed entities (all pages crawled): `152` (`+0` today)
- Queue: `done 21 (+0)`, `processing 10 (+0)`, `pending 145,864 (+596)`, `errors 0 (+0)`
...
|---|---:|---:|---:|---:|---:|---|
| 2026-07-14 | 16,096,056 | +6,638 | 773,427 | 152 | 145,864 |  |
