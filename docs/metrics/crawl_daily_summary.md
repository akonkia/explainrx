...
- Snapshot window: `2026-07-05T00:01:48+02:00` to `2026-07-05T21:45:32+02:00` local (`206` snapshots)
- Entities in KB: `1,188,811` (`+140,938` today)
- Relationships in KB: `18,181,135` (positive gain `+3,494,519`, net `+3,470,041`)
- Completed entities (all pages crawled): `1,375` (`+558` today)
- Queue: `done 1,386 (+630)`, `processing 10 (+4)`, `pending 858,035 (+201,009)`, `errors 212 (+49)`
...
|---|---:|---:|---:|---:|---:|---|
| 2026-07-05 | 18,181,135 | +3,494,519 | 1,188,811 | 1,375 | 858,035 | 2 drop/reset day, errors +49 |
