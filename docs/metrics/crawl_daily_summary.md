...
- Snapshot window: `2026-07-09T00:03:18+02:00` to `2026-07-09T21:02:05+02:00` local (`359` snapshots)
- Entities in KB: `763,286` (`-5,262` today)
- Relationships in KB: `15,786,051` (positive gain `+96,547`, net `-144,112`)
...
|---|---:|---:|---:|---:|---:|---|
| 2026-07-09 | 15,786,051 | +96,547 | 763,286 | 19 | 117,532 | 1 drop/reset day |
