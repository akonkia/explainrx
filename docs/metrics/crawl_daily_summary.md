...
- Snapshot window: `2026-07-06T00:25:20+02:00` to `2026-07-06T11:05:25+02:00` local (`85` snapshots)
- Entities in KB: `1,244,846` (`+49,978` today)
- Relationships in KB: `18,650,221` (positive gain `+786,388`, net `+341,831`)
- Completed entities (all pages crawled): `1,606` (`+206` today)
- Queue: `done 1,627 (+215)`, `processing 9 (-1)`, `pending 905,814 (+38,940)`, `errors 226 (+12)`
...
|---|---:|---:|---:|---:|---:|---|
| 2026-07-06 | 18,650,221 | +786,388 | 1,244,846 | 1,606 | 905,814 | 11 drop/reset day, errors +12 |
